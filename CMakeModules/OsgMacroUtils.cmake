...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OSGQT_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${OSGQT_VERSION} SOVERSION ${OSGQT_SOVERSION})
    ENDIF(OSGQT_SONAMES)
...
MACRO(SETUP_LIBRARY LIB_NAME)
    ...
    ENDIF()
        ...
        ADD_LIBRARY(${LIB_NAME}
            ${OSGQT_USER_DEFINED_DYNAMIC_OR_STATIC}
            ${TARGET_H}
...
MACRO(SETUP_PLUGIN PLUGIN_NAME)
    ...
    SET(TARGET_SRC ${TARGET_SRC} ${OSGQT_VERSIONINFO_RC})
...
MACRO(SETUP_EXE IS_COMMANDLINE_APP)
    ...
    ELSE(${IS_COMMANDLINE_APP})
        ...
        IF(APPLE)
            # SET(MACOSX_BUNDLE_LONG_VERSION_STRING "${OSGQT_MAJOR_VERSION}.${OSGQT_MINOR_VERSION}.${OSGQT_PATCH_VERSION}")
            # Short Version is the "marketing version". It is the version
            # the user sees in an information panel.
            SET(MACOSX_BUNDLE_SHORT_VERSION_STRING "${OSGQT_MAJOR_VERSION}.${OSGQT_MINOR_VERSION}.${OSGQT_PATCH_VERSION}")
            # Bundle version is the version the OS looks at.
            SET(MACOSX_BUNDLE_BUNDLE_VERSION "${OSGQT_MAJOR_VERSION}.${OSGQT_MINOR_VERSION}.${OSGQT_PATCH_VERSION}")
...
MACRO(HANDLE_MSVC_DLL)
        ...
        #it is hardcoded, we should compute OUTPUT_BINDIR position relative to OUTPUT_LIBDIR ... to be implemented
        #changing bin to something else breaks this hack
        #the dll are versioned by prefixing the name with osg${OSGQT_SOVERSION}-
        ...
        ELSE(${ARGC} GREATER 1)
                SET(LIB_SOVERSION ${OSGQT_SOVERSION})
        ENDIF(${ARGC} GREATER 1)
...
#     SET_TARGET_PROPERTIES(${LIB_NAME} PROPERTIES PREFIX "../../bin/osg${OSGQT_SOVERSION}-")
