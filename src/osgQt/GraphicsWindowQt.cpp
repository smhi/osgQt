...
public:
    QtKeyboardMap()
    {
        ...
        mKeyMap[ Qt::Key_0]   = osgGA::GUIEventAdapter::KEY_0;
        mKeyMap[Qt::Key_1] = osgGA::GUIEventAdapter::KEY_1;  
        mKeyMap[Qt::Key_2] = osgGA::GUIEventAdapter::KEY_2;  
        mKeyMap[Qt::Key_3] = osgGA::GUIEventAdapter::KEY_3;  
        mKeyMap[Qt::Key_4] = osgGA::GUIEventAdapter::KEY_4;  
        mKeyMap[Qt::Key_5] = osgGA::GUIEventAdapter::KEY_5;  
        mKeyMap[Qt::Key_6] = osgGA::GUIEventAdapter::KEY_6;  
        mKeyMap[Qt::Key_7] = osgGA::GUIEventAdapter::KEY_7;  
        mKeyMap[Qt::Key_8] = osgGA::GUIEventAdapter::KEY_8;  
        mKeyMap[Qt::Key_9] = osgGA::GUIEventAdapter::KEY_9;  
        mKeyMap[Qt::Key_Colon] = osgGA::GUIEventAdapter::KEY_Colon;  
        mKeyMap[Qt::Key_Semicolon] = osgGA::GUIEventAdapter::KEY_Semicolon;  
        mKeyMap[Qt::Key_Less] = osgGA::GUIEventAdapter::KEY_Less; 
        mKeyMap[Qt::Key_Equal] = osgGA::GUIEventAdapter::KEY_Equals;  
        mKeyMap[Qt::Key_Greater] = osgGA::GUIEventAdapter::KEY_Greater;  
        mKeyMap[Qt::Key_Question] = osgGA::GUIEventAdapter::KEY_Question;  
        mKeyMap[Qt::Key_At] = osgGA::GUIEventAdapter::KEY_At;  
